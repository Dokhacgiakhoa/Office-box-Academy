...
### 🎯 Mục tiêu bài học
Cấy ghép "Trí nhớ dài hạn" (Agent Memory) cho AI bằng công nghệ MCP (Model Context Protocol), giúp Claude nhớ được toàn bộ quy tắc code của bạn qua từng ngày.

### 🧠 Cấy ghép Trí nhớ cho Đặc vụ (MCP Memory)
AI thường "não cá vàng" khi bắt đầu một phiên chat mới. Hãy dạy nó cách nhớ.
- **Thực hành:** Cấu hình MCP Server Memory chính chủ từ Anthropic.
- Mở file cấu hình \`claude_desktop_config.json\` và thêm đoạn mã JSON để kích hoạt \`@modelcontextprotocol/server-memory\`.
- **Prompt thử nghiệm:** *"Kể từ nay, bạn hãy GHI NHỚ rằng tôi luôn dùng TailwindCSS cho mọi dự án, và không bao giờ dùng var trong JavaScript. Hãy lưu điều này vào bộ nhớ Knowledge Graph của bạn."*
Ngay lập tức, Claude sẽ dùng công cụ tự lưu vào ổ cứng. Ngày mai mở máy lên, nó vẫn sẽ nhớ quy tắc của bạn như một nhân viên trung thành!
`;
