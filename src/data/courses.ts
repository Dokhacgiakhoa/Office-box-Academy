...
*Hãy bấm thử nút **Shorten** để xem Gemini cắt gọt nội dung thư xin lỗi ở Bài 4 như thế nào nhé!*`
  ...
  },
  {
    ...
    tier: "OFFICE",
    skills: [
      { id: "sk-2-1", title: "[Gemini] Yêu cầu chuẩn bị: Sử dụng ứng dụng trên Google Workspace", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-2-2", title: "[Gemini] Công thức Prompt: Trích xuất ý chính từ đoạn hội thoại dài", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-2-3", title: "[Gemini] Ví dụ minh họa: Tóm tắt biên bản cuộc họp nội bộ", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-2-4", title: "[Google Calendar] Mẹo: Dùng câu lệnh để AI tự động lên lịch hẹn", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "OFFICE",
    skills: [
      { id: "sk-3-1", title: "[ChatGPT] Yêu cầu chuẩn bị: Tài khoản ChatGPT Free hoặc Plus", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-3-2", title: "[ChatGPT] Công thức Prompt: Lập dàn ý bài thuyết trình cấu trúc 3 phần", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-3-3", title: "[Claude] Công thức Prompt: Căn chỉnh lỗi logic và kiểm tra chính tả", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-3-4", title: "[Claude] Ví dụ minh họa: Soạn thảo mẫu hợp đồng dịch vụ chuẩn pháp lý", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "OFFICE",
    skills: [
      { id: "sk-4-1", title: "[DeepSeek] Yêu cầu chuẩn bị: Đăng ký tài khoản DeepSeek miễn phí", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-4-2", title: "[DeepSeek] Công thức Prompt: Yêu cầu AI viết hàm VLOOKUP, IF lồng nhau", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-4-3", title: "[DeepSeek] Ví dụ minh họa: Dọn dẹp khoảng trắng và gộp cột dữ liệu thô", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "OFFICE",
    skills: [
      { id: "sk-5-1", title: "[NotebookLM] Yêu cầu chuẩn bị: Đăng nhập bằng tài khoản Google", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-5-2", title: "[NotebookLM] Nguồn dữ liệu: Cách tải file PDF, Google Docs lên hệ thống an toàn", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-5-3", title: "[NotebookLM] Ví dụ minh họa: Sinh bản tin Audio 2 người trò chuyện từ báo cáo", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "OFFICE",
    skills: [
      { id: "sk-6-1", title: "[Freepik AI] Công thức Prompt: Tả nhân vật, bối cảnh và tỷ lệ khung hình", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-6-2", title: "[Freepik AI] Ví dụ minh họa: Tạo ảnh banner quảng cáo sản phẩm", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-6-3", title: "[Flux] Công thức Prompt: Tạo hình ảnh siêu thực với chi tiết phức tạp", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-6-4", title: "[Flux] Ví dụ minh họa: Sinh ảnh nhân vật đồng nhất", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "OFFICE",
    skills: [
      { id: "sk-7-1", title: "[Veo 3] Công thức Prompt: Điều khiển góc máy quay (Phóng to, lia máy)", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-7-2", title: "[Veo 3] Ví dụ minh họa: Tạo video giới thiệu cảnh quan văn phòng", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-7-3", title: "[Kling] Công thức Prompt: Tạo chuyển động cho nhân vật từ ảnh tĩnh", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-7-4", title: "[Luma] Ví dụ minh họa: Biến bản vẽ phác thảo thành video 3D", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  ...
  // --- NHÁNH 2: AI AGENT (LEVEL 8-13) (PROJECT-BASED) ---
  {
    ...
    tier: "MARKETING",
    skills: [
      { id: "sk-8-1", title: "[n8n] 30% Lý thuyết: Hiểu nguyên lý cốt lõi của một luồng tự động (Trigger & Action)", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-8-2", title: "[n8n] 70% Thực hành: Cài đặt n8n phiên bản Cloud (Đám mây) nhanh chóng", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-8-3", title: "[n8n] 70% Thực hành: Cài đặt n8n phiên bản Local (Máy cá nhân vĩnh viễn)", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "MARKETING",
    skills: [
      { id: "sk-9-1", title: "[n8n] 30% Lý thuyết: Hướng dẫn cách lấy mã khóa liên kết (Token) từ tài khoản Facebook", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-9-2", title: "[n8n] 70% Thực hành: Viết luồng cào tin tức báo chí, đưa cho AI xào nấu lại văn phong", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-9-3", title: "[n8n] 70% Thực hành: Thiết lập hẹn giờ (Schedule) tự động đăng bài lúc 8h sáng mỗi ngày", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "MARKETING",
    skills: [
      { id: "sk-10-1", title: "[n8n] 30% Lý thuyết: Bóc tách luồng làm video ngắn (Kịch bản -> Giọng đọc -> Hình ảnh)", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-10-2", title: "[n8n] 70% Thực hành: Dùng n8n kết nối API sinh kịch bản và đọc giọng nói nhân tạo", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-10-3", title: "[n8n] 70% Thực hành: Ghép hình ảnh/âm thanh và tự động đẩy file video lên kênh TikTok", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    id: "course-n8n-email",
    ...
    tier: "MARKETING",
    skills: [
      { id: "sk-11-1", title: "[n8n] 30% Lý thuyết: Cách kết nối n8n với hòm thư Gmail/Outlook bảo mật", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-11-2", title: "[n8n] 70% Thực hành: Lên sơ đồ bắt AI đọc nội dung Email và phân loại mức độ khẩn cấp", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-11-3", title: "[n8n] 70% Thực hành: Dạy AI tự động soạn trước bản nháp phản hồi và lưu vào thư mục Draft", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "MARKETING",
    skills: [
      { id: "sk-12-1", title: "[n8n] 30% Lý thuyết: Khái niệm về HTTP Request và cách gọi API lấy dữ liệu", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-12-2", title: "[n8n] 70% Thực hành: Cấu hình lấy dữ liệu giá Vàng/Coin theo mốc thời gian thực 1 phút/lần", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-12-3", title: "[n8n] 70% Thực hành: Rẽ nhánh - Nếu giá biến động > 5%, tự động bắn tin nhắn vào nhóm", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    id: "course-n8n-crm",
    ...
    tier: "MARKETING",
    skills: [
      { id: "sk-13-1", title: "[n8n] 30% Lý thuyết: Cấu trúc dữ liệu chuẩn của một thẻ khách hàng (Lead, Deal)", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-13-2", title: "[n8n] 70% Thực hành: Tự động gom đơn hàng từ Website đẩy gọn gàng sang Google Sheets", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-13-3", title: "[n8n] 70% Thực hành: Chấm điểm khách VIP và tự động chia luân phiên cho nhân viên Sale", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  ...
  // --- NHÁNH 3: VIBECODING (LEVEL 14-18) (PROJECT-BASED) ---
  {
    ...
    tier: "EXPERT",
    skills: [
      { id: "sk-14-1", title: "[Claude] 30% Lý thuyết: Cấu trúc chuẩn SEO của một trang Landing Page (Hero, Tính năng...)", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-14-2", title: "[Stitch] 70% Thực hành: Ra lệnh cho AI tự động dựng bố cục giao diện siêu tốc", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-14-3", title: "[Vercel] 70% Thực hành: Tải mã nguồn về và đưa trang web lên Internet với một cú click", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    id: "course-vibe-game",
    ...
    tier: "EXPERT",
    skills: [
      { id: "sk-15-1", title: "[Claude] 30% Lý thuyết: Hiểu quy luật tọa độ và khung hình (Canvas) trong lập trình Game", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-15-2", title: "[Claude] 70% Thực hành: Viết Prompt mô tả luật chơi và yêu cầu AI tự sinh mã nguồn", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-15-3", title: "[Claude] 70% Thực hành: Kỹ năng gỡ rối: Chơi thử game, copy lỗi ném cho AI để nhờ vá lỗi", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "EXPERT",
    skills: [
      { id: "sk-16-1", title: "[Claude] 30% Lý thuyết: Cấu trúc và luồng dữ liệu của một trang Giỏ hàng trực tuyến", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-16-2", title: "[Stitch] 70% Thực hành: Nhờ AI dựng giao diện trang danh sách sản phẩm và thẻ Card", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-16-3", title: "[Antigravity] 70% Thực hành: Tạo bảng cơ sở dữ liệu để lưu trữ đơn hàng thực tế của khách", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    ...
    tier: "EXPERT",
    skills: [
      { id: "sk-17-1", title: "[Claude] 30% Lý thuyết: Nguyên lý Website trò chuyện với bộ não ChatGPT qua API", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-17-2", title: "[Claude] 70% Thực hành: Lấy mã khóa API (Secret Key) và ghép thành công vào giao diện chat", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-17-3", title: "[Vercel] 70% Thực hành: Cấu hình ẩn mã khóa (Bảo mật biến môi trường) trước khi tung lên mạng", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  },
  {
    id: "course-vibe-saas",
    ...
    tier: "EXPERT",
    skills: [
      { id: "sk-18-1", title: "[Claude] 30% Lý thuyết: Luồng người dùng (Đăng ký, Đăng nhập, Thêm, Sửa, Xóa dữ liệu)", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-18-2", title: "[Stitch] 70% Thực hành: Thiết kế Bảng điều khiển (Dashboard) trực quan, có biểu đồ", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" },
      { id: "sk-18-3", title: "[Antigravity] 70% Thực hành: Cấu hình phân quyền dữ liệu (Nhân viên chỉ được thấy việc của họ)", duration: "5 phút đọc", youtubeVideoId: "dQw4w9WgXcQ" }
    ]
  }
];
